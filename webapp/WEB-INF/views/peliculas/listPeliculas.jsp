            ...
            <c:forEach items="${peliculas.content}" var="pelicula">
            	<tr>
	                ...
	                <td>
	                    ...
	                    <a href="${urlDelete}/${pelicula.id}" onclick='return confirm("¿Estás seguro?")' class="btn btn-danger btn-sm" role="button" title="Eliminar" ><span class="glyphicon glyphicon-trash"></span></a>
	                </td>
	            </tr>
            </c:forEach>
        </table>
