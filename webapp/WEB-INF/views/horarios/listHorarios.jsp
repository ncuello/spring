...
<html lang="en">
  <head>
    ...
    <spring:url value="/horarios/create" var="urlCreate"></spring:url>
    <spring:url value="/horarios/update" var="urlEdit"></spring:url>
  ...
  <body>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <a href="${urlCreate}" class="btn btn-success" role="button" title="Nuevo Horario" >Nuevo</a><br><br>
            ...
            <c:forEach items="${horarios.content}" var="horario">
            	<tr>
            		...
            		<td>
	                    ...
	                    <a href="${urlDelete}/${horario.id}" class="btn btn-danger btn-sm" role="button" title="Eliminar" ><span class="glyphicon glyphicon-trash"></span></a>
	                </td>
            	</tr>
            </c:forEach>
        </table>
